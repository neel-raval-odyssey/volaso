...
const TopSection: React.FC = () => {
  ...
  return (
    ...
    >
      {/* Header */}
      <header
        className={`fixed top-0 left-0 right-0 flex items-center justify-between p-4 z-10 transition-colors duration-300 ${
          isScrolled ? "bg-black bg-opacity-50" : "bg-opacity-0"
        }`}
      >
